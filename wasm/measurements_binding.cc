...
EMSCRIPTEN_BINDINGS(measurements) {
    static auto HeadingMeasurement_MESSAGE_TYPE = HeadingMeasurement::MESSAGE_TYPE;
    static auto HeadingMeasurement_MESSAGE_VERSION = HeadingMeasurement::MESSAGE_VERSION;
    class_<HeadingMeasurement>("HeadingMeasurement")
        ...
        .property("heading_true_north_deg", &HeadingMeasurement::heading_true_north_deg)
