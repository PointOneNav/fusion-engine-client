...
EMSCRIPTEN_BINDINGS(device) {
    static auto SystemStatusMessage_MESSAGE_TYPE = SystemStatusMessage::MESSAGE_TYPE;
    ...
    class_<SystemStatusMessage>("SystemStatusMessage")
        ...
        .class_property("INVALID_TEMPERATURE", &SystemStatusMessage_INVALID_TEMPERATURE)
