...
constexpr unsigned COMPONENT_TYPE_SHIFT = 0;
constexpr unsigned COMPONENT_TYPE_BITS = 2;
...
constexpr uint16_t ToSignalVal(SatelliteType sv_type, FrequencyBand freq_band,
  ...
  return static_cast<uint8_t>(sv_type) << SATELLITE_TYPE_SHIFT |
         ...
         static_cast<uint8_t>(component) << COMPONENT_TYPE_SHIFT;
}
...
P1_CONSTEXPR_FUNC FrequencyBand GetFrequencyBand(GNSSSignalType signal) {
  return static_cast<FrequencyBand>(static_cast<uint8_t>(
      (static_cast<uint16_t>(signal) >> FREQUENCY_BAND_SHIFT) &
...
P1_CONSTEXPR_FUNC ComponentType GetComponentType(GNSSSignalType signal) {
  return static_cast<ComponentType>(static_cast<uint8_t>(
      (static_cast<uint16_t>(signal) >> COMPONENT_TYPE_SHIFT) &
      ((1 << COMPONENT_TYPE_BITS) - 1)));
}
...
P1_CONSTEXPR_FUNC GPSSignalName GetGPSSignalName(GNSSSignalType signal) {
  return static_cast<GPSSignalName>(static_cast<uint8_t>(
      (static_cast<uint16_t>(signal) >> SIGNAL_NAME_SHIFT) &
...
GetGLONASSSignalName(GNSSSignalType signal) {
...
GetGalileoSignalName(GNSSSignalType signal) {
