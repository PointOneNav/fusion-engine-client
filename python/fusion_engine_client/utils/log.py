...
CANDIDATE_P1LOG_FILES = [
    ...
    # Diagnostic file generated by the engine when logging containing incoming sensor data, diagnostic information, and
    # select user output. This file has the same content as would be captured in real time over TCP, etc. if diagnostic
    # output is enabled.
