...
class IMUMessage(MessagePayload):
    ...
    def pack(self, buffer: bytes = None, offset: int = 0, return_buffer: bool = True) -> (bytes, int):
        ...
        struct.pack_into(
            ...
            self.angular_velocity_rps[0],
            self.angular_velocity_rps[1],
            self.angular_velocity_rps[2],
            self.angular_velocity_covariance[0],
            self.angular_velocity_covariance[1],
            self.angular_velocity_covariance[2],
            self.angular_velocity_covariance[3],
            self.angular_velocity_covariance[4],
            self.angular_velocity_covariance[5],
            self.angular_velocity_covariance[6],
            self.angular_velocity_covariance[7],
            self.angular_velocity_covariance[8],
            self.acceleration_mps2[0],
            self.acceleration_mps2[1],
            self.acceleration_mps2[2],
            self.acceleration_covariance[0],
            self.acceleration_covariance[1],
            self.acceleration_covariance[2],
            self.acceleration_covariance[3],
            self.acceleration_covariance[4],
            self.acceleration_covariance[5],
            self.acceleration_covariance[6],
            self.acceleration_covariance[7],
            self.acceleration_covariance[8],
        )
