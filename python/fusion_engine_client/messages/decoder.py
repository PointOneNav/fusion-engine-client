...
from .internal import MessageHeader, MessageType, MessagePayload, message_type_to_class
...
class FusionEngineDecoder:
  ...
  def __init__(self):
    ...
    # TODO: Add wild card
    self._callbacks: Dict[MessageType, List[Callable[[MessageHeader, MessagePayload], None]]] = defaultdict(list)
