...
WASM_SIGNAL_DEFS_PATH = ROOT_DIR.parent / 'wasm/signal_defs_bindings.cc'
CPP_INDENT = '  '
PYTHON_INDENT = '    '
...
try:
    from fusion_engine_client.messages.signal_defs import (
        BeiDouSignalName, ComponentType, FrequencyBand, GalileoSignalName,
...
class GNSSSignalTypeDefinition(NamedTuple):
    ...
    component_type: ComponentType = ComponentType.COMBINED
...
GNSS_SIGNAL_TYPE_DEFINITIONS = {
    ...
    'GPS_L1C_D': GNSSSignalTypeDefinition(SatelliteType.GPS, FrequencyBand.L1, GPSSignalName.L1C, ComponentType.DATA),
    'GPS_L1C_P': GNSSSignalTypeDefinition(SatelliteType.GPS, FrequencyBand.L1, GPSSignalName.L1C, ComponentType.PILOT),
    'GPS_L2C': GNSSSignalTypeDefinition(SatelliteType.GPS, FrequencyBand.L2, GPSSignalName.L2C),
    'GPS_L2C_M': GNSSSignalTypeDefinition(SatelliteType.GPS, FrequencyBand.L2, GPSSignalName.L2C, ComponentType.DATA),
    'GPS_L2C_L': GNSSSignalTypeDefinition(SatelliteType.GPS, FrequencyBand.L2, GPSSignalName.L2C, ComponentType.PILOT),
    ...
    'GPS_L5_I': GNSSSignalTypeDefinition(SatelliteType.GPS, FrequencyBand.L5, GPSSignalName.L5, ComponentType.DATA),
    'GPS_L5_Q': GNSSSignalTypeDefinition(SatelliteType.GPS, FrequencyBand.L5, GPSSignalName.L5, ComponentType.PILOT),
    ...
    'GALILEO_E1B': GNSSSignalTypeDefinition(SatelliteType.GALILEO, FrequencyBand.L1, GalileoSignalName.E1BC, ComponentType.DATA),
    'GALILEO_E1C': GNSSSignalTypeDefinition(SatelliteType.GALILEO, FrequencyBand.L1, GalileoSignalName.E1BC, ComponentType.PILOT),
    'GALILEO_E5B': GNSSSignalTypeDefinition(SatelliteType.GALILEO, FrequencyBand.L2, GalileoSignalName.E5B),
    'GALILEO_E5B_I': GNSSSignalTypeDefinition(SatelliteType.GALILEO, FrequencyBand.L2, GalileoSignalName.E5B, ComponentType.DATA),
    'GALILEO_E5B_Q': GNSSSignalTypeDefinition(SatelliteType.GALILEO, FrequencyBand.L2, GalileoSignalName.E5B, ComponentType.PILOT),
    'GALILEO_E5A': GNSSSignalTypeDefinition(SatelliteType.GALILEO, FrequencyBand.L5, GalileoSignalName.E5A),
    'GALILEO_E5A_I': GNSSSignalTypeDefinition(SatelliteType.GALILEO, FrequencyBand.L5, GalileoSignalName.E5A, ComponentType.DATA),
    'GALILEO_E5A_Q': GNSSSignalTypeDefinition(SatelliteType.GALILEO, FrequencyBand.L5, GalileoSignalName.E5A, ComponentType.PILOT),
    ...
    'GALILEO_E6B': GNSSSignalTypeDefinition(SatelliteType.GALILEO, FrequencyBand.L6, GalileoSignalName.E6BC, ComponentType.DATA),
    'GALILEO_E6C': GNSSSignalTypeDefinition(SatelliteType.GALILEO, FrequencyBand.L6, GalileoSignalName.E6BC, ComponentType.PILOT),
    ...
    'BEIDOU_B1C_D': GNSSSignalTypeDefinition(SatelliteType.BEIDOU, FrequencyBand.L1, BeiDouSignalName.B1C, ComponentType.DATA),
    'BEIDOU_B1C_P': GNSSSignalTypeDefinition(SatelliteType.BEIDOU, FrequencyBand.L1, BeiDouSignalName.B1C, ComponentType.PILOT),
    ...
    'BEIDOU_B2A_D': GNSSSignalTypeDefinition(SatelliteType.BEIDOU, FrequencyBand.L5, BeiDouSignalName.B2A, ComponentType.DATA),
    'BEIDOU_B2A_P': GNSSSignalTypeDefinition(SatelliteType.BEIDOU, FrequencyBand.L5, BeiDouSignalName.B2A, ComponentType.PILOT),
    ...
    'SBAS_L5_I': GNSSSignalTypeDefinition(SatelliteType.SBAS, FrequencyBand.L5, SBASSignalName.L5, ComponentType.DATA),
    'SBAS_L5_Q': GNSSSignalTypeDefinition(SatelliteType.SBAS, FrequencyBand.L5, SBASSignalName.L5, ComponentType.PILOT),
    ...
    'QZSS_L1C_D': GNSSSignalTypeDefinition(SatelliteType.QZSS, FrequencyBand.L1, QZSSSignalName.L1C, ComponentType.DATA),
    'QZSS_L1C_P': GNSSSignalTypeDefinition(SatelliteType.QZSS, FrequencyBand.L1, QZSSSignalName.L1C, ComponentType.PILOT),
    'QZSS_L2C': GNSSSignalTypeDefinition(SatelliteType.QZSS, FrequencyBand.L2, QZSSSignalName.L2C),
    'QZSS_L2C_M': GNSSSignalTypeDefinition(SatelliteType.QZSS, FrequencyBand.L2, QZSSSignalName.L2C, ComponentType.DATA),
    'QZSS_L2C_L': GNSSSignalTypeDefinition(SatelliteType.QZSS, FrequencyBand.L2, QZSSSignalName.L2C, ComponentType.PILOT),
    'QZSS_L5': GNSSSignalTypeDefinition(SatelliteType.QZSS, FrequencyBand.L5, QZSSSignalName.L5),
    'QZSS_L5_I': GNSSSignalTypeDefinition(SatelliteType.QZSS, FrequencyBand.L5, QZSSSignalName.L5, ComponentType.DATA),
    'QZSS_L5_Q': GNSSSignalTypeDefinition(SatelliteType.QZSS, FrequencyBand.L5, QZSSSignalName.L5, ComponentType.PILOT),
    'QZSS_L6': GNSSSignalTypeDefinition(SatelliteType.QZSS, FrequencyBand.L2, QZSSSignalName.L6),
    'QZSS_L6_M': GNSSSignalTypeDefinition(SatelliteType.QZSS, FrequencyBand.L2, QZSSSignalName.L6, ComponentType.DATA),
    'QZSS_L6_L': GNSSSignalTypeDefinition(SatelliteType.QZSS, FrequencyBand.L2, QZSSSignalName.L6, ComponentType.PILOT),
}
...
def python_signal_enum_value_str(signal_def: GNSSSignalTypeDefinition) -> str:
    ...
    FORMAT_STR = 'to_signal_val(SatelliteType.{}, FrequencyBand.{}, ' + \
        type(signal_def.signal_name).__name__ + '.{}, ComponentType.{})'
...
def generate_cpp_bit_shift_constants(enum_type: type[_GNSSSignalPartType]) -> str:
    '''!
    Generate the C++ source code for the `*_SHIFT` and `*_BITS` constants.
    '''
    name = enum_type.__name__
    bit_packing = _get_gnss_enum_bit_packing(enum_type)  # type: ignore
    return f'''\
P1_CONSTEXPR_FUNC {name} Get{name}(GNSSSignalType signal) {{
  return static_cast<{name}>(
      static_cast<uint8_t>((static_cast<uint16_t>(signal) >> {bit_packing.bit_offset}) & {hex((1 << bit_packing.bit_len) - 1)}));
}}'''
...
P1_CONSTEXPR_FUNC {name} Get{name}(GNSSSignalType signal) {{
  return static_cast<{name}>(
      static_cast<uint8_t>((static_cast<uint16_t>(signal) >> {cpp_prefix}_SHIFT) & ((1 << {cpp_prefix}_BITS) - 1)));
}}'''
...
def generate_wasm_enum_binding(name: str, values: Iterable) -> str:
    '''!
    Generate a WASM enum binding like:
    ...
    ```
    '''
    binding_code = f'enum_<{name}>("{name}")\n'
    value_bindings = [ f'    .value("{v}", {name}::{v})' for v in values ]
    binding_code += '\n'.join(value_bindings) + ';'
    return binding_code

def generate_wasm_signal_defs() -> str:
    '''!
    Generate all the generated C++ source code. This includes enum definitions and helper functions.
    '''
    def _make_functions(enum_type: type[_GNSSSignalPartType]):
        if enum_type == GNSSSignalType:
            values = ['UNKNOWN']
            values = values + list(GNSS_SIGNAL_TYPE_DEFINITIONS.keys())
            return generate_wasm_enum_binding('GNSSSignalType', values) + '\n\n'
        else:
            values = [v.name for v in enum_type]  # type: ignore
            return generate_wasm_enum_binding(enum_type.__name__, values) + '\n\n'
...
def update_cpp_code(check_only=False) -> bool:
    """!
    @brief Generate source code contents for @ref SatelliteType, @ref FrequencyBand, @ref ComponentType, @ref
...
def update_wasm_code(check_only=False) -> bool:
    """!
    @brief Generate WASM bindings @ref SatelliteType, @ref FrequencyBand, @ref ComponentType, @ref
           GPSSignalName, @ref GLONASSSignalName, @ref BeiDouSignalName, @ref GalileoSignalName, @ref SBASSignalName,
           @ref QZSSSignalName, and @ref GNSSSignalType.

    If `not check_only` then replace the contents in wasm/signal_defs_bindings.cc with the newly generated values.
    ...
    @return `True` if newly generated code differed from the previously generated code.
    """
    generated_wasm_code = '\n' + indent(generate_wasm_signal_defs(), CPP_INDENT)
    differs = get_generated_code_in_file(WASM_SIGNAL_DEFS_PATH) != generated_wasm_code
    if differs:
        if check_only:
                print('WASM file out of date.')
        else:
            print('Updating generated WASM code.')
            update_generated_code_in_file(WASM_SIGNAL_DEFS_PATH, generated_wasm_code)
    else:
        print('Generated WASM code matches current file contents.')
    return differs
...
""")
    ...
    differs |= update_wasm_code(check_only=options.check_only)
